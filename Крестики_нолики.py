...
area = [['*', '*', '*'], ['*', '*', '*'], ['*', '*', '*']]
print('Добро положаловать в крестики-нолики')
print('------------------------------------')
draw_area()
for turn in range(1, 10):
    ...
    row = int(input('Ввведите номер строки (1,2,3) ')) - 1
    column = int(input('Ввведите номер столбца (1,2,3) ')) - 1
    if area[row][column] == '*':
